...
export default function VisualsDemo() {
  return (
    <div className="min-h-screen px-8 pb-8 pt-32">
      <h1 className="text-3xl font-bold mb-8 text-center bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent">COLREG Lights & Shapes</h1>
